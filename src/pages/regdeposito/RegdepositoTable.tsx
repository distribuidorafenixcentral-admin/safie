...
const columnHelper = createColumnHelper<Regdeposito>()

export default function RegdepositoTable({
  data,
  onView,
  onEdit,
  onDelete
  ...
  data: Regdeposito[]
  onView: (row: Regdeposito) => void
  onEdit: (row: Regdeposito) => void
  onDelete: (row: Regdeposito) => void
}) {
